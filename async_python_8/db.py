...
def _clean_sms_status(value: Any) -> str:
...
class Database:
    ...
    Схема ключей в базе данных:
        ...
        mailing_id -> максимальный id рассылки
    """
    ...
    async def get_pending_sms_list(self) -> List:
    ...
    async def update_sms_status_in_bulk(self, sms_list: List) -> None:
    ...
    async def get_mailing_id(self) -> int:
        """return id for new mailing"""
        return await self.redis.incr("mailing_id")
